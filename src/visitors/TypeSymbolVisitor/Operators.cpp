...
void TypeSymbolVisitor::handleMinusOperator(BinaryOpNode &node, std::shared_ptr<TypeNode> leftType, std::shared_ptr<TypeNode> rightType)
{
    std::string left = leftType->toString();
    std::string right = rightType->toString();
...
void TypeSymbolVisitor::handleMulOperator(BinaryOpNode &node, std::shared_ptr<TypeNode> leftType, std::shared_ptr<TypeNode> rightType)
{
    std::string left = leftType->toString();
    std::string right = rightType->toString();
...
void TypeSymbolVisitor::handleDivOperator(BinaryOpNode &node, std::shared_ptr<TypeNode> leftType, std::shared_ptr<TypeNode> rightType)
{
    std::string left = leftType->toString();
    std::string right = rightType->toString();
...
void TypeSymbolVisitor::handleModOperator(BinaryOpNode &node, std::shared_ptr<TypeNode> leftType, std::shared_ptr<TypeNode> rightType)
{
    std::string left = leftType->toString();
    std::string right = rightType->toString();
...
void TypeSymbolVisitor::handleCompareOperator(BinaryOpNode &node, std::shared_ptr<TypeNode> leftType, std::shared_ptr<TypeNode> rightType)
{
    std::string left = leftType->toString();
    std::string right = rightType->toString();
...
void TypeSymbolVisitor::handleLogicalOperator(BinaryOpNode &node, std::shared_ptr<TypeNode> leftType, std::shared_ptr<TypeNode> rightType)
{
    std::string left = leftType->toString();
    std::string right = rightType->toString();
